...
pipe = utils.images2img.StableDiffusionImages2ImgPipeline.from_pretrained(pretrained_model_name_or_path = "runwayml/stable-diffusion-v1-5", revision="fp16", torch_dtype=torch.float16, safety_checker=None, requires_safety_checker=False)
...
image = pipe("4K, dark", latents=lat, image = img, image2 = img2, strength=0.6, num_inference_steps = 20).images[0]
